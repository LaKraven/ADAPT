...
procedure TAdaptUnitTestGenericsLookupList.Add;
var
...
procedure TAdaptUnitTestGenericsLookupList.AddItems_FromArray;
var
  LList: IStringLookupList;
begin
...
procedure TAdaptUnitTestGenericsLookupList.AddItems_FromLookupList;
var
...
procedure TAdaptUnitTestGenericsLookupList.Compact;
var
  LList: IStringLookupList;
begin
...
procedure TAdaptUnitTestGenericsLookupList.Contains;
var
  LList: IStringLookupList;
begin
  LList := TStringLookupList.Create(ADStringComparer, 10);
...
procedure TAdaptUnitTestGenericsLookupList.ContainsAll;
var
  LList: IStringLookupList;
begin
  LList := TStringLookupList.Create(ADStringComparer, 10);
...
procedure TAdaptUnitTestGenericsLookupList.ContainsAny;
var
  LList: IStringLookupList;
begin
  LList := TStringLookupList.Create(ADStringComparer, 10);
...
procedure TAdaptUnitTestGenericsLookupList.ContainsNone;
var
  LList: IStringLookupList;
begin
  LList := TStringLookupList.Create(ADStringComparer, 10);
...
procedure TAdaptUnitTestGenericsLookupList.Delete;
var
  LList: IStringLookupList;
begin
  LList := TStringLookupList.Create(ADStringComparer, 10);
...
procedure TAdaptUnitTestGenericsLookupList.IndexOf_PreOrdered;
var
...
procedure TAdaptUnitTestGenericsLookupList.IndexOf_Unordered;
const
